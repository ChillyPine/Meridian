...
open class TextFeature(
    ...
    private fun renderInput(g: GuiGraphicsExtractor, font: Font) {
        ...
        if (value.isEmpty() && !focused && placeholder.isNotEmpty()) {
            g.text(font, placeholder, textInsetX, textY, 0xFF777777.toInt(), false)
        } else {
            g.text(font, visible, textInsetX, textY, 0xFFFFFFFF.toInt(), false)
        }
